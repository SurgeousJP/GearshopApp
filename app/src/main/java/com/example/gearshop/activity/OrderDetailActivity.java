...
public class OrderDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OrderIDTextView.setText(clickedOrder.getID());

        OrderCreatedDateTextView = findViewById(R.id.order_day);
        OrderCreatedDateTextView.setText(new SimpleDateFormat("dd/MM/yyyy").format(clickedOrder.getCreatedOnUtc()));
        ...
        OrderShippingDateTextView.setText(new SimpleDateFormat("dd/MM/yyyy").format(updatedDate));
...
//        OrderDetailAdapter = new OrderListAdapter(getBaseContext(), DatabaseHelper.getOrderItemList())

        TotalPriceTextView = findViewById(R.id.total_price_order_detail);
        TotalPriceTextView.setText(
                MoneyHelper.getVietnameseMoneyStringFormatted(clickedOrder.getTotalPrice() - customerProvince.getShippingCharge())
        );
        ...
        FinalPriceTextView.setText(MoneyHelper.getVietnameseMoneyStringFormatted(clickedOrder.getTotalPrice()));
    }
    ...
    private Date getIncrementedDate(Order clickedOrder) {
        ...
        calendar.set(orderCreateDate.getYear(), orderCreateDate.getMonth(), orderCreateDate.getDate());
